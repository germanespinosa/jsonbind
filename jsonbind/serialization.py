...
class Serialization:
    ...
    def serialize(value: typing.Any) -> str:
        ...
        if bond:
            return json.dumps(bond.to_json_value(python_value=value), separators=(',', ':'))
        raise TypeError("value type '%s' is not serializable" % value_type.__name__)

    @staticmethod
    def deserialize(json_string: str, python_type: type = None) -> typing.Any:
    ...
    @staticmethod
    def set_default_bond(json_type: typing.Union[JsonTypes], python_type: type) -> None:
